...
function mostrarCalendario(){
    ...
    $.when(dataPermisos).done(function (){
...
function btnEliminar(f) {
    $.ajax(
        {
            type:'DELETE',
            url:'./api/Permisos.php?f='+f,
...
function btnModificar() {
    ...
    $('#RRHH2').fullCalendar('updateEvent', NuevoEvento);
...
function EnviarInformacion(f,objEvento) {
...
function ModificarInformacion(f,objEvento) {
