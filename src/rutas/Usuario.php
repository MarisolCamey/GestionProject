...
$app->post('/api/Usuario/nuevo', function(Request $request, Response $response){
  ...
  $sql = ("CALL sp_InsertUsuario ('$Nombre','$Correo','$Telefono','$NomUsuario','$Pass','$IdCompany', '$IdRol', '$IdUsuario')");
...
$app->put('/api/Usuario/modificar/{IdUsuario}', function(Request $request, Response $response){
  ...
  $sql = ("CALL sp_ModUsuario ('$IdUsuario','$Nombre','$Correo','$Telefono','$NomUsuario','$Pass','$IdCompany', '$IdRol')");
